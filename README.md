...
100 *number* *attribute first letter uppercase* *number* *attribute first letter uppercase* ...
>   this line is for the answerA.
200 *number* *attribute first letter uppercase* *number* *attribute first letter uppercase* ...
